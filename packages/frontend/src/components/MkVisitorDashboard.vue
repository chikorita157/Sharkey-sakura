...
<div v-if="instance" :class="$style.root">
	...
	<div :class="[$style.main, $style.panel]">
		<div :class="$style.mainAbout">
			...
			<p><b>Sakurajima</b> is your gateway to the Japanese media (Anime/Manga/Visual Novels/Video Games/etc) fandom and creator community on the Fediverse and BlueSky (using the <a href="https://fed.brid.gy/docs#fediverse-get-started">the BlueSky Bridge</a>, an opt-in third party service). You can connect with other fans and creators on the Fediverse. You can learn more about our services and more on <a href='https://joinsakurajima.org'>our official website</a>.</p>
		</div>
	</div>
